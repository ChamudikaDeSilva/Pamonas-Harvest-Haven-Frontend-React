      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className={`absolute top-full left-0 w-full bg-white md:relative md:flex md:items-center md:justify-center md:space-x-4 ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
          <div className="flex flex-col sm:flex-row sm:space-x-4 sm:space-y-0">
            <a href="/" className="hover:text-amber-500 text-gray-500 text-lg font-semibold py-2 px-4">Home</a>
            ...
            <div className="relative">
              ...
              <ul className={`md:absolute md:bg-gray-200 md:rounded-lg md:pt-1 md:text-gray-700 md:w-48 sm:w-40 sm:relative sm:bg-transparent md:shadow-lg ${isDropdownOpen ? 'block' : 'hidden'}`}>
                <li className="group">
                  <a href="/" className="bg-gray-200 text-gray-500 hover:bg-amber-500 py-2 px-4 block whitespace-no-wrap text-base font-semibold">Cart</a>
                </li>
                <li className="group">
                  <a href="/" className="bg-gray-200 text-gray-500 hover:bg-amber-500 py-2 px-4 block whitespace-no-wrap text-base font-semibold">Checkout</a>
                </li>
                <li className="group">
                  <a href="/" className="bg-gray-200 text-gray-500 hover:bg-amber-500 py-2 px-4 block whitespace-no-wrap text-base font-semibold">Testimonial</a>
                </li>
              </ul>
            </div>
            <a href="/" className="hover:text-amber-500 text-gray-500 font-semibold text-lg py-2 px-4">Contact</a>
          </div>
