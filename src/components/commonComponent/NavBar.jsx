...
const NavBar = () => {
  ...
  return (
    <nav className='bg-white p-4 sticky top-0 left-0 w-full z-50'>
      ...
      <Link
        to='/'
        className='bg-gradient-to-r from-lime-500 via-amber-400 to-green-600 bg-clip-text text-fill-transparent text-md md:text-l lg:text-xl xl:text-2xl font-bold'
      >
        ...
        <div className='flex items-center'>
          <div className='ml-4 md:hidden'>
            <button
              className='text-lime-500 hover:text-amber-500 focus:outline-none'
        ...
        <div
          className={`absolute top-full left-0 w-full bg-white md:relative md:flex md:items-center md:justify-center md:space-x-4 ${
        ...
        >
          <div className='flex flex-col sm:flex-row sm:space-x-4 sm:space-y-0'>
            <Link
              ...
              className={`text-lg font-semibold py-2 px-4 ${
                activeItem === 'home' ? 'text-amber-500' : 'text-gray-500'
            ...
            <Link
              to='/about-us'
              className={`text-lg font-semibold py-2 px-4 ${
                activeItem === 'about-us' ? 'text-amber-500' : 'text-gray-500'
              } hover:text-amber-500`}
            ...
            <Link
              to='/shop'
              className={`text-lg font-semibold py-2 px-4 ${
                activeItem === 'shop' ? 'text-amber-500' : 'text-gray-500'
              } hover:text-amber-500`}
            ...
            <div className='relative'>
              <button
                className='hover:text-amber-500 text-gray-500 text-lg font-semibold focus:outline-none py-2 px-4'
                onClick={togglePagesDropdown}
              >
                Pages{' '}
                <FontAwesomeIcon
                  icon={isPagesDropdownOpen ? faChevronUp : faChevronDown}
                  className='ml-1'
                />
              </button>
              <ul
                className={`md:absolute md:bg-gray-200 md:rounded-lg md:pt-1 md:text-gray-700 md:w-48 sm:w-40 sm:relative sm:bg-transparent md:shadow-lg ${
              ...
              >
                <li className='group'>
                  <Link
                    ...
                    className={`bg-gray-200 text-gray-500 hover:bg-amber-500 py-2 px-4 block whitespace-no-wrap text-base font-semibold ${
                      activeItem === 'cart' ? 'text-amber-500' : ''
                    }`}
                ...
                <li className='group'>
                  <Link
                    to=''
                    className={`bg-gray-200 text-gray-500 hover:bg-amber-500 py-2 px-4 block whitespace-no-wrap text-base font-semibold ${
                      activeItem === 'checkout' ? 'text-amber-500' : ''
                    }`}
            ...
            <Link
              to='/contact-us'
              className={`text-lg font-semibold py-2 px-4 ${
                activeItem === 'contact' ? 'text-amber-500' : 'text-gray-500'
              } hover:text-amber-500`}
          ...
          <div className='flex justify-center pb-4 pt-2'>
            <FontAwesomeIcon
              ...
              className='hover:text-amber-500 text-lime-500 text-2xl ml-2 md:ml-4'
            />
            ...
            <div className='relative'>
              <FontAwesomeIcon
                ...
                onClick={() =>
                  user ? toggleUserDropdown() : setIsSigninModalOpen(true)
                }
              />
              {user && (
                <ul
                ...
                >
                  ...
                  <li
                    className='bg-gray-200 text-gray-500 hover:bg-amber-500 py-2 px-4 block whitespace-no-wrap text-base font-semibold cursor-pointer'
                    onClick={logout}
                  >
                    Logout
                  </li>
