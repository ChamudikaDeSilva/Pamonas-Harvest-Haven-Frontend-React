                                            ...
                                            <tr key={index} className="border-b">
                                                <td className="py-4 px-2">
                                                    <div className="flex flex-col items-center md:items-start">
                                                        ...
                                                        />
                                                        <span className="font-semibold text-center md:text-left text-sm">{item.name || 'Unnamed Product'}</span>
                                                    </div>
                                                </td>
                                                <td className="py-4 px-2 text-sm">Rs.{parseFloat(item.price).toFixed(2)}</td>
                                                <td className="py-4 px-2 text-sm">{item.quantity || 1}</td>
                                                <td className="py-4 px-2 text-sm">Rs.{(parseFloat(item.price) * (item.quantity || 1)).toFixed(2)}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
