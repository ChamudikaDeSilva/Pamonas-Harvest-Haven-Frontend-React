    ...
    return(
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-center items-center text-white">
          <div className="text-3xl md:text-4xl lg:text-5xl font-bold pb-1">Terms & Conditions</div>
          <div className="text-sm md:text-base lg:text-lg text-lime-500">
            <span className="font-semibold text-lime-500">Pamona's</span> / Terms & Conditions
          </div>
        </div>
      </div>
    );
